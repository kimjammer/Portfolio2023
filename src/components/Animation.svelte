...
<style lang="scss">
  ...
  @keyframes circlecrop {
	...
	80% {
      clip-path: circle(min(50vw, 50vh));
    }
    100% {
  ...
  .wrapper2{
    animation: shrink var(--animationDuration) forwards;
    overflow: hidden;
    height: 100vmax;
    width: 100vmax;
    position: absolute;
  ...
  .wrapper {
	animation: movelogo var(--animationDuration) ease-in-out forwards;
	position: static;
	overflow: hidden;
