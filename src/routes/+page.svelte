<script>
	...
	//This is the function that slickScroll uses to determine if it should run or not. If it is going to disable itself,
	//we need to make sure that we don't try to initialize it (It will break the site flow).
	function slickScrollEnabled() {
		let check = false;
		(function (a) {
...
<style>
	:global(body) {
		...
		--color-accent: #596BE3;
		--color-accent-secondary: #FFA07D;
		--color-translucent: #EDF5FF7F;
